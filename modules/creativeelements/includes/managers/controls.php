...
class ControlsManager
{
    ...
    public function addCustomCssControls($element)
    {
        ...
        $element->addControl(
            'custom_css',
            array(
                'label' => __('Add your own custom CSS here', 'elementor'),
                'description' => __('Use "selector" to target wrapper element. Examples:', 'elementor') .
                '<pre class="elementor-panel-alert elementor-panel-alert-info" style="font-size:11px; font-style:normal;">' . __(
                    "/* For main element */\nselector { color: red; }\n" .
