        ...
        <div class="col-lg-6">
            <div class="panel clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Parent affiliate' mod='psaffiliate'}</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">
                                {if $affiliate.id_parent_affiliate}
                                    <a href="{$affiliate.parent_affiliate_link}" target="_blank">{$affiliate.parent_affiliate_name|escape:'htmlall':'UTF-8'}</a>
                                {else}
                                    -
                                {/if}
                            </p>
                ...
                <div class="form-horizontal">
                    <div class="row">
                        ...
                        <div class="col-lg-9"><p
                                    class="form-control-static">{if $affiliate.per_click}{Psaffiliate::displayPriceOverride($affiliate.per_click)|escape:'html':'UTF-8'}{else}{l s='--' mod='psaffiliate'}{/if}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Per unique click' mod='psaffiliate'}</label>
                        <div class="col-lg-9"><p
                                    class="form-control-static">{if $affiliate.per_unique_click}{Psaffiliate::displayPriceOverride($affiliate.per_unique_click)|escape:'html':'UTF-8'}{else}{l s='--' mod='psaffiliate'}{/if}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Per sale' mod='psaffiliate'}</label>
                        <div class="col-lg-9"><p
                                    class="form-control-static">{if $affiliate.per_sale}{Psaffiliate::displayPriceOverride($affiliate.per_sale)|escape:'html':'UTF-8'}{else}{l s='--' mod='psaffiliate'}{/if}</p>
                        </div>
                    </div>
                    <div class="row">
            ...
            <div class="panel clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9"><p
                                    class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.earnings)|escape:'html':'UTF-8'}</p></div>
                    </div>
                </div>
            </div>
            <div class="panel clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9"><p
                                    class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.earnings_total)|escape:'html':'UTF-8'}</p></div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Total payments' mod='psaffiliate'}</label>
                        <div class="col-lg-9"><p
                                    class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.payments)|escape:'html':'UTF-8'}</p></div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Pending payments' mod='psaffiliate'}</label>
                        <div class="col-lg-9"><p
                                    class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.pending_payments)|escape:'html':'UTF-8'}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Balance' mod='psaffiliate'}</label>
                        <div class="col-lg-9"><p class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.balance)|escape:'html':'UTF-8'}</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <table class="table">
                        ...
                        {foreach $campaigns AS $key => $tr}
                            <tr ondblclick="document.location = '{$link->getAdminLink('AdminPsaffiliateCampaigns')|escape:'html':'UTF-8'}&amp;id_campaign={$tr.id_campaign|escape:'htmlall':'UTF-8'}&amp;viewaff_campaigns'">
                                ...
                                <td>{Psaffiliate::displayPriceOverride($tr.total_earnings)|escape:'html':'UTF-8'}</td>
                            </tr>
                        {/foreach}
                        </tbody>
                    </table>
                        ...
                        {foreach $rates AS $key => $tr}
                            <tr>
                                ...
                                <td>
                                    ...
                                    {else}
                                        {if $tr.value}{Psaffiliate::displayPriceOverride($tr.value)|escape:'html':'UTF-8'}{else}{l s='--' mod='psaffiliate'}{/if}
                                    {/if}
                                </td>
                            </tr>
                        {/foreach}
