            ...
            <div class="panel clearfix">
                ...
                <div class="form-horizontal">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <p class="form-control-static">{Psaffiliate::displayPriceOverride($campaign.total_earnings_clicks)|escape:'html':'UTF-8'}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Earnings from sales' mod='psaffiliate'}</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">{Psaffiliate::displayPriceOverride($campaign.total_earnings_sales)|escape:'html':'UTF-8'}</p>
                        </div>
                    </div>
                    <div class="row">
                        <label class="control-label col-lg-3">{l s='Total earnings' mod='psaffiliate'}</label>
                        <div class="col-lg-9">
                            <p class="form-control-static">{Psaffiliate::displayPriceOverride($campaign.total_earnings)|escape:'html':'UTF-8'}</p>
                        </div>
                    </div>
                </div>
            </div>
