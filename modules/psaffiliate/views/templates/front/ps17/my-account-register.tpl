                    ...
                    <div class="form-group clearfix">
                        ...
                        <div class="col-sm-8">
                            <input type="text" name="email" id="email"
                                   value="{$customer_email|escape:'htmlall':'UTF-8'}" disabled="disabled"
                                   class="form-control"/>
                        </div>
                    </div>
                    {if $ask_for_website}
                            ...
                            <div class="offset-sm-4 col-sm-8">
                                <p>
                                    <label><input type="checkbox" name="terms_and_conditions"
                                        ...
                                        {l s='I accept the' mod='psaffiliate'} <a href="{$terms_cms_link}"
                                                                                  target="_blank">
                    ...
                    <div class="form-group">
                        <div class="offset-sm-4 col-sm-8">
                            <button type="submit" id="psaff_register"
                                    class="btn btn-secondary"{if $display_terms_checkbox && $terms_cms_link} disabled{/if}>
