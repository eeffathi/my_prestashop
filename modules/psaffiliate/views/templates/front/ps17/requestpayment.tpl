        ...
        <div class="card">
            ...
            <div class="card-block">
                ...
                {else}
                        ...
                        <form class="requestapayment-form form-horizontal" method="POST" enctype="multipart/form-data">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-5 col-md-4">
                                    <div class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.balance, $default_currency)|escape:'htmlall':'UTF-8'}</div>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-sm-3"
                    ...
                    {else}
                        {l s='You still need another %s to reach the minimum payment amount.' mod='psaffiliate' sprintf=[{Psaffiliate::displayPriceOverride($minimum_payment_amount-$affiliate.balance)}]}
                    {/if}
                {/if}
            </div>
        </div>
