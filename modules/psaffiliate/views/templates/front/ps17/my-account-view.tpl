                ...
                <div class="col-md-3">
                    <ul class="nav nav-pills nav-panel nav-stacked">
                        ...
                        {if $voucher_to_share_enabled}
                            <li class="nav-item"><a href="#myaffiliateaccount-voucherstoshare" data-toggle="tab"
                                                    class="nav-link">{l s='Vouchers to share' mod='psaffiliate'}</a></li>
                        {/if}
                        ...
                        {/if}
                        {if $mlm_enable}
                            <li class="nav-item"><a href="#myaffiliateaccount-mlm" data-toggle="tab"
                                                    class="nav-link">{l s='Multi level marketing' mod='psaffiliate'}</a>
                            </li>
                        {/if}
                    </ul>
                </div>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            ...
                                            <div class="list-group list-group-hover">
                                                ...
                                                <div class="list-group-item">
                                                    <span class="pull-xs-right font-bold">{Psaffiliate::displayPriceOverride(Tools::convertPrice($affiliate.earnings, $currency))|escape:'htmlall':'UTF-8'}</span>
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="list-group list-group-hover">
                                                ...
                                                <div class="list-group-item">
                                                    <span class="pull-xs-right font-bold">{Psaffiliate::displayPriceOverride(Tools::convertPrice($affiliate.earnings_total, $currency))|escape:'htmlall':'UTF-8'}</span>
                                                    <span>{l s='Total earnings' mod='psaffiliate'}</span>
                                                </div>
                                                <div class="list-group-item">
                                                    <span class="pull-xs-right font-bold">{Psaffiliate::displayPriceOverride(Tools::convertPrice($affiliate.payments, $currency))|escape:'htmlall':'UTF-8'}</span>
                                                    <span>{l s='Total payments' mod='psaffiliate'}</span>
                                                </div>
                                                <div class="list-group-item">
                                                    <span class="pull-xs-right font-bold">{Psaffiliate::displayPriceOverride(Tools::convertPrice($affiliate.pending_payments, $currency))|escape:'htmlall':'UTF-8'}</span>
                                                    <span>{l s='Pending payments' mod='psaffiliate'}</span>
                                                </div>
                                                <div class="list-group-item">
                                                    <span class="pull-xs-right font-bold">{Psaffiliate::displayPriceOverride(Tools::convertPrice($affiliate.balance, $currency))|escape:'htmlall':'UTF-8'}</span>
                                        ...
                                        <table id="campaigns" class="table table-hover table-striped b-t m-n">
                                            ...
                                            {foreach from=$campaigns item=campaign}
                                                <tr>
                                                    ...
                                                    <td class="text-xs-right">{Psaffiliate::displayPriceOverride(Tools::convertPrice($campaign.total_earnings_clicks + $campaign.total_earnings_sales, $currency))|escape:'htmlall':'UTF-8'}</td>
                                ...
                                {else}
                                    <table class="table table-hover table-striped b-t m-n">
                                        ...
                                        <tr>
                                            <th>{l s='ID' mod='psaffiliate'}</th>
                                            {if $mlm_enable}
                                                <th>{l s='Aff origin' mod='psaffiliate'}</th>
                                            {/if}
                                        ...
                                        {foreach $sale_commissions as $commission}
                                            <tr>
                                                ...
                                                {if $mlm_enable}
                                                    <td class="v-middle">{$commission.affiliate_origin_name}</td>
                                                {/if}
                        ...
                        {if $voucher_to_share_enabled}
                            <div class="tab-pane" id="myaffiliateaccount-voucherstoshare">
                                <div class="card">
                                    <div class="card-header clearfix text-center-xs">
                                        <h3 class="m-t-sm m-b-sm pull-sm-left float-md-left">{l s='Vouchers to share' mod='psaffiliate'}</h3>
                                        {if $hasVouchersToShare}
                                            <div class="pull-sm-right float-md-right m-t-n-xs">
                                                <a href="{$link->getModuleLink('psaffiliate', 'voucherstoshare', ['add_voucher' => true], true)|escape:'html':'UTF-8'}"
                                                   class="btn btn-secondary m-t-xs"><i
                                                            class="material-icons">photo</i> {l s='Create a voucher' mod='psaffiliate'}
                                                </a>
                                            </div>
                                        {/if}
                                    </div>
                                            ...
                                            <table class="table table-hover table-striped b-t m-n">
                                                ...
                                                {foreach $lifetime_affiliations as $row}
                                                    <tr>
                                                        ...
                                                        <td>{Psaffiliate::displayPriceOverride(Tools::convertPrice($row.commission, $currency))|escape:"htmlall":"UTF-8"}</td>
                                                    </tr>
                                                {/foreach}
                                                </tbody>
                                            </table>
                            ...
                            <div class="tab-pane" id="myaffiliateaccount-mlm">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        ...
                                        {/if}
                                        <br />
                                        <p class="alert alert-info" data-id-aff="{$mlm_parent_info.id_parent_affiliate}">{l s='The affiliate who brought you here: %s' mod='psaffiliate' sprintf=[$parent_aff_label]}</p>
                                        {if $enable_affiliates_details}
                                            <div id="affiliate_modal_{$mlm_parent_info.id_parent_affiliate}" class="affiliate_modal" style="display:none">
                                                <h1>Affiliate Details</h1>
                                                <span class="aff_details_close">x</span>
                                                <div class="form-wrapper">
                                                    <div class="form-group row">
                                                        <label class="control-label col-lg-4 "><span class="label-tooltip" title="" >First Name</span></label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_firstname" id="p_firstname" value="{$mlm_parent_info.parent_affiliate_details.firstname}" class="" disabled></div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="control-label col-lg-4 "><span class="label-tooltip" title="" >Last Name</span></label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_lastname" id="p_lastname" value="{$mlm_parent_info.parent_affiliate_details.lastname}" class="" disabled></div>
                                                    </div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 "><span class="label-tooltip" title="">Company</span></label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_company" id="p_company" value="{$mlm_parent_info.parent_affiliate_details.company}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Address</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_address1" id="p_address1" value="{$mlm_parent_info.parent_affiliate_details.address1}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Address (2)</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_address2" id="p_address2" value="{$mlm_parent_info.parent_affiliate_details.address2}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Zip/postal code</label><div class="col-lg-4"><input type="text" name="p_postcode" id="p_postcode" value="{$mlm_parent_info.parent_affiliate_details.postcode}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">City</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_city" id="p_city" value="{$mlm_parent_info.parent_affiliate_details.city}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Country</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_country" id="p_country" value="{$mlm_parent_info.parent_affiliate_details.country}" class="" disabled></div></div>
                                                    <div class="form-group row" id="contains_states"><label class="control-label col-lg-4 ">State</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_state" id="p_state" value="{$mlm_parent_info.parent_affiliate_details.state} " class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Phone</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_phone" id="p_phone" value="{$mlm_parent_info.parent_affiliate_details.phone}" class="" disabled></div></div>
                                                    <div class="form-group row"><label class="control-label col-lg-4 ">Email</label><div class="col-lg-8 col-sm-6 col-xs-6"><input type="text" name="p_email" id="p_email" value="{$mlm_parent_info.parent_affiliate_details.email}" class="" disabled></div></div>
                                                </div>
                                            </div>
                                        {/if}
                                                ...
                                                {if $affiliates}
                                                    ...
                                                    <table class="table table-hover table-striped b-t m-n">
                                                        ...
                                                        {foreach $affiliates as $key => $aff}
                                                            ...
                                                            {/if}
                                                            <tr data-id-aff="{$aff.id_affiliate}">
                                                                ...
                                                                <td>{Psaffiliate::displayPriceOverride(Tools::convertPrice($aff.sales_generated, $currency))|escape:"htmlall":"UTF-8"}</td>
                                                            </tr>
                                                        {/foreach}
                                                        </tbody>
                                                    </table>
