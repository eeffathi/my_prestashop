    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            {else}
                    ...
                    <form class="requestapayment-form form-horizontal" method="POST" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-5 col-md-4">
                                <div class="form-control-static">{Psaffiliate::displayPriceOverride($affiliate.balance,$default_currency)|escape:'html':'UTF-8'}</div>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-sm-3"
                ...
                {else}
                    {l s='You still need another %s to reach the minimum payment amount.' mod='psaffiliate' sprintf={Psaffiliate::displayPriceOverride($minimum_payment_amount-$affiliate.balance)|escape:'html':'UTF-8'}}
                {/if}
            {/if}
        </div>
    </div>
