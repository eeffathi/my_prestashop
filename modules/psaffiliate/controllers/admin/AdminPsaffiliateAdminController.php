...
class AdminPsaffiliateAdminController extends AdminController
{
    ...
    {
        $this->moduleObj->loadClasses(array('Sale', 'Tracking', 'Payment', 'Affiliate', 'Campaign', 'AffConf'));
...
//        $sign = (AffConf::getConfig('point_commissions') ? (empty(AffConf::getConfig('commissions_name', true))) ? 'Points' : AffConf::getConfig('commissions_name', true) : $currency->iso_code); /* Something to do later. */
        $js_def = array(
        ...
        $this->context->smarty->assign(array(
            ...
            'mlm_enable' => (bool)AffConf::getConfig('mlm_enable'),
        ));
