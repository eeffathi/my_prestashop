...
class Campaign extends ObjectModel
{
    ...
    public function __construct($id = null)
    {
        ...
        if ($id) {
            ...
            $this->total_earnings_clicks_formatted = Psaffiliate::displayPriceOverride($this->total_earnings_clicks);
            ...
            $this->total_earnings_sales_formatted = Psaffiliate::displayPriceOverride($this->total_earnings_sales);

            $this->total_earnings = number_format($this->total_earnings_clicks + $this->total_earnings_sales, 2);
            $this->total_earnings_formatted = Psaffiliate::displayPriceOverride($this->total_earnings);
