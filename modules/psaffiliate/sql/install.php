...
`id_parent_affiliate` int(10) NOT NULL,
...
`rate_value` FLOAT NOT NULL,
`multiplier` FLOAT NOT NULL DEFAULT 1,
`extra_commission_value` FLOAT NOT NULL,
...
`id_affiliate` int(10) NOT NULL,
`id_affiliate_origin` int(10) NOT NULL,
...
$sql[] = "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."aff_vts` (
