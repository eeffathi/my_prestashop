...
<div class="panel">
    <a class="product_labels_doc" href="{$link_on_tab_module|escape:'quotes':'UTF-8'}">{l s='Documentation' mod='seosaproductlabels'}</a>
    <a id="seosa_manager_btn" href="#">{l s='Our modules' mod='seosaproductlabels'}</a>
</div>
