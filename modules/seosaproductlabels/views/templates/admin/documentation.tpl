...
<div class="custom_bootstrap">
    <a class="back_link button btn btn-default"
       href="{Context::getContext()->link->getAdminLink('AdminProductLabels', true)|escape:'quotes':'UTF-8'}">{l s='Back' mod='seosaproductlabels'}</a>
