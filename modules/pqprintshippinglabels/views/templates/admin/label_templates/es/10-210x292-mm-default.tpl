...
<div style="position: absolute; width: 176px; background-color: white; left: 400px; top: 116px;">
...
<div style="position: absolute; width: 176px; background-color: white; left: 564px; top: 116px;">
...
<div style="position: absolute; background-color: white; width: 50%; left: 15px; top: 230px;">
...
<div style="position: absolute; background-color: white; width: 50%; left: 383px; top: 230px;">
<span style=" font-size: 14pt;">
 <b>DELIVERED TO:</b><br>
...
<div style="position: absolute; background-color: white; width: 90%; left: 15px; top: 374px;">
<table border="1" width="100%">
	<tr>
		<td style="width: 55px;"><span style="font-size: 12pt;">Img.</span></td>
		<td style="width: 50%;"><span style="font-size: 12pt;">Product name</span></td>
		<td><span style="font-size: 12pt;">Quantity</span></td>
		<td><span style="font-size: 12pt;">Price</span></td>
	</tr>
<!--{foreach from=$order_products item=item}-->
	<tr>
		<td style="width: 55px;"><img style="width: 50px; height: 50px; margin: 5px;" src="{$ps_img}tmp/product_mini_{$item.product_id}_1.jpg" alt="" /></td>
		<td style="width: 50%"><span style="font-size: 12pt;">{$item.product_name}</span></td>
		<td><span style="font-size: 12pt;">{$item.product_quantity}</span></td>
		<td><span style="font-size: 12pt;">{$item.product_price|string_format:"%.2f"}</span></td>
	</tr>
<!--{/foreach}-->
