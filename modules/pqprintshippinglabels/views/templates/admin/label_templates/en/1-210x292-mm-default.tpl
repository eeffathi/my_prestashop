...
<div style="position: absolute; background-color: white; width: 50%; left: 15px; top: 277px;">
...
<div style="position: absolute; background-color: white; width: 50%; left: 383px; top: 277px;">
<span style=" font-size: 14pt;">
 <b>DELIVERED TO:</b><br>
