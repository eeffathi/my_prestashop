...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'presta_h2s', 'user' => 'prestauser', 'password' => 'Operation123@#$', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('zgLLxn8RVEDs7dCEdTzRx9cTZmxdZHwPMNXEpWM5SDtkLSKkMYoBZkkJDgdLYXqx'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('zgLLxn8RVEDs7dCEdTzRx9cTZmxdZHwPMNXEpWM5SDtkLSKkMYoBZkkJDgdLYXqx');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'kernel.active_modules' => [
                ...
                63 => 'recaptcha',
                64 => 'upliftsearch',
                65 => 'seosaproductlabels',
                66 => 'psaffiliate',
                67 => 'exportproducts',
                68 => 'amazzingfilter',
                69 => 'ordersexport',
                70 => 'cdc_googletagmanager',
                71 => 'pqprintshippinglabels',
                72 => 'simpleimportproduct',
                73 => 'brandlist',
            ],
            ...
            'kernel.secret' => 'zgLLxn8RVEDs7dCEdTzRx9cTZmxdZHwPMNXEpWM5SDtkLSKkMYoBZkkJDgdLYXqx',
